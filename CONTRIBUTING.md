...
To edit the Objective-C files, open `example/ios/ScReactNativeBranchExample.xcworkspace` in XCode and find the source files at `Pods > Development Pods > sc-react-native-branch`.
